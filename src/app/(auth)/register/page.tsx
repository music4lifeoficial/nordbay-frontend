  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <h2 className="text-2xl font-bold text-nordic-900">Create your account</h2>
        <p className="mt-2 text-nordic-600">Join the Nordic marketplace community</p>
      </div>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div>
          ...
          <div className="relative mt-1">
            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-nordic-400 h-4 w-4" />
            <Input
              id="name"
              type="text"
              autoComplete="name"
        ...
        <div className="flex items-center">
          ...
          />
          <label htmlFor="accept_terms" className="ml-2 block text-sm text-nordic-900">
            I agree to the{' '}
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-nordic-600">Or sign up with</span>
          </div>
        </div>
